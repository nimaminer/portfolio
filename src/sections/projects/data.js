...
export const data = [
    {
        ...
        imageTwoeAlt: "Image of dailyflow's layout on mac",
        imageTwoWidth: 450,
    ...
    },
    {
        ...
        imageTwoeAlt: "Image of Sounds Media's layout on iphone 14 pro",
        imageTwoWidth: 390,
    ...
    },
    {
        ...
        imageTwoeAlt: "Image of billboard showing IronMan's promotional poster",
        imageTwoWidth: 480,
    ...
    },
    {
        ...
        firstText: ["Tools:", parse(`<strong>BAdobe XD, Adobe Premiere Pro, Adobe Illustrator, Miro.</strong>`)],
        ...
        imageTwoeAlt: "Image of billboard showing The Line's promotional poster",
        imageTwoWidth: 470,
    ...
    },
    {
        ...
        firstText: ["Skills:", parse(`<strong>Adobe XD, Adobe Premiere Pro, Adobe Illustrator, Miro.</strong>`)],
        secondText: ["Design Methods: ", parse(`<strong>Utilizing: variables, functions, conditionals, loops, arrays, test cases, file input/output, classes, objects, recursion, and multi-dimensional arrays.</strong>`)],
        mBottom: 80,
    ...
    },
    {
        ...
        imageTwoeAlt: "Image of The Time Vessel's visual layout on an Iphone 14 pro",
        imageTwoWidth: 150,
