...
export const data = [
    {
        ...
        projectType: "'University Project'",
        title: 'Glacial Shift',
        mainText: parse(`GlacialShift is an immersive VR timescape game that illustrates the impact of climate change and human activity on penguin habitats. Set in the Arctic, the game begins with a vibrant environment teeming with penguins and a thriving ecosystem. As players advance, they witness a gradual decline in the penguin population, melting icebergs, rising sea levels, and increasing signs of industrialization. By 2050, the penguins have disappeared, prompting players to take action to prevent this grim future.<br></br> The GlacialShift project was part of a series of assessments focused on exploring AR and VR design principles for educational and entertainment purposes. Another project from these assessments, ShellSavers, was developed as an AR Snapchat Lens to engage users in a fun and interactive way about the conservation needs of endangered turtle species.`),
        firstText: ["Tools:", parse(`<strong>Unity, SnapChat Lens Studio, Adobe Premiere Pro, Figma.</strong>`)],
        secondText: ["Skills:", parse(`<strong>Creating VR & AR Interfaces (Environments) Using Unity, and Snapchat Lens.<strong>`)],
        mBottom: 80,
        imageOneSrc: "images/projects/glacial-shift/TV.png",
        imageOneAlt: "Image of Glacial Shift's game on a TV",
        imageOneWidth: 470,
        imageTwoSrc: "images/projects/glacial-shift/Glasses.png",
        imageTwoAlt: "Image of Glacial Shift's game on a VR headset",
        imageTwoWidth: 470,
        secInfoText: "Unit Of Study: DECO3009 Designing For Virtual Reality",
        buttonProps: ["#00F9AE", "0px 5px 5px rgba(0, 0, 0, 0.25)", "Full Design Process / Deliverables", 25, "#000000", 440, 50],
        id: "glacial-shift",
        isOpen: false
    },
    ...
    },
    {
        ...
        firstText: ["Tools:", parse(`<strong>Blender, Fusion360, Rhino7, Adobe Photoshop, Adobe InDesign.</strong>`)],
    ...
    },
    {
        ...
        projectType: "'University Project'",
        title: 'InkBall',
        mainText: parse(`For this assignment, I was responsible for building a fully functional Inkball game from the ground up using Java and Gradle. I needed to become proficient in Java and design sophisticated data structures to represent key game elements such as, balls, timers, cells, walls, and more.<br></br>In preparation, I completed a series of smaller coding tasks and quizzes that put Java into practice some include: managing inter-file communication, reading and interpreting input to produce specific outputs, solving complex algorithmic problems, constructing elaborate object models, and ultimately developing a fully playable Minesweeper game. Together, these projects not only helped me master Java as a programming language but also deepened my grasp of object-oriented principles and broadened my knowledge of data structures and algorithms.`),
        firstText: ["Languages:", parse(`<strong>Java</strong>`)],
        secondText: ["Skills:", parse(`<strong>Utilizing: variables, functions, conditionals, loops, arrays, test cases, file input/output, classes, objects, recursion, and multi-dimensional arrays, as well as Gradle.</strong>`)],
        mBottom: 80,
        imageOneSrc: "images/projects/ink-ball/laptop.png",
        imageOneAlt: "Image of The InkBall's game on a laptop screen",
        imageOneWidth: 600,
        secInfoText: "Unit Of Study: INFO1113 Object-Oriented Programming",
